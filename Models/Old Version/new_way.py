...
for n in range(len(test_predictions_with_rules)):
    if test_predictions_with_rules[n] == 1 and x_test.iloc[n]['Caudal_impulses'] == 0 and x_test.iloc[n]['median_oil_temperature'] > 50:
        #print(x_test.iloc[n])
        #test_predictions_with_rules[n] = 0
        count = count+1
        if y_test[n] == 0:
...
for n in range(len(test_predictions_with_rules)):
    if test_predictions_with_rules[n] == 0 and x_test.iloc[n]['median_h1'] > -0.002 and x_test.iloc[n]['LPS'] == 1:
        #print(x_test.iloc[n])
        test_predictions_with_rules[n] = 1
        count = count+1
        if y_test[n] == 1:
