...
model2 = joblib.load('best_model_catboost.pkl')
model3 = joblib.load('best_model_xgboost.pkl')
model4 = joblib.load('best_model_Lightgbm.pkl')
model5 = joblib.load('best_model_svm.pkl')
model6 = joblib.load('best_model_KNN.pkl')
...
voting_classifier.fit(x_train, np.ravel(y_train))
